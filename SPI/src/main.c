...
#define ECG_RATE_HZ 1000
#define ECG_NOTIF_HZ  50
#define ECG_INT_US  (1000000 / ECG_RATE_HZ)
#define ECG_PKT_N   (ECG_RATE_HZ / ECG_NOTIF_HZ)
#define MAX_DIGITS   7    
#define LINE_LEN     (1 + MAX_DIGITS * ECG_PKT_N + 1)
