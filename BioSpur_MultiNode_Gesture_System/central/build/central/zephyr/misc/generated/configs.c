...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_TX_COUNT, 16);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_CMD_TX_COUNT, 8);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GATT_DM_WORKQ_OWN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GATT_DM_WORKQ_STACK_SIZE, 1300);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GATT_DM_WORKQ_PRIO, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GATT_DM_WORKQ_INIT_PRIO, 50);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DFU_SMP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DFU_SMP_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DFU_SMP_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_COUNT, 16);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_EVT_RX_COUNT, 16);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_TX_BUF_COUNT, 16);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_TX_FRAG_COUNT, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ATT_TX_COUNT, 16);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_RTT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_RTT_0, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_RTT_DRIVER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_TRANSPORT_UART, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_TRANSPORT_UART_MTU, 256);
