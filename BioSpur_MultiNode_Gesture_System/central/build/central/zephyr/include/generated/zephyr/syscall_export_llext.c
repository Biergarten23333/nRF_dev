...
extern __weak ALIAS_OF(no_handler) void * const z_impl_wdt_setup;
extern __weak ALIAS_OF(no_handler) void * const z_impl_wdt_disable;
extern __weak ALIAS_OF(no_handler) void * const z_impl_wdt_feed;
