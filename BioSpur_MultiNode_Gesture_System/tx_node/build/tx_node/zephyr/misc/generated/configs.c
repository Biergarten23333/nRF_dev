...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_CMD_TX_COUNT, 6);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_COUNT, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_EVT_RX_COUNT, 8);
