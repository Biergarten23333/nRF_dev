...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYSTEM_WORKQUEUE_STACK_SIZE, 6144);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_TX_COUNT, 48);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MAX_CONN, 15);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_COUNT, 48);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CONN_FRAG_COUNT, 15);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CONN_TX_MAX, 48);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_TX_BUF_COUNT, 48);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_TX_FRAG_COUNT, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ATT_TX_COUNT, 48);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MAX_PAIRED, 15);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SEGGER_RTT_BUFFER_SIZE_DOWN, 64);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_PID, 0x520F);
