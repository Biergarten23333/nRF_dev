...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF_HFXO_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF_IEEE802154_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF_LFXO_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_CALIBRATION_PERIOD, 4000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_USE_CRACEN_ASYMMETRIC_DRIVER, 1);
