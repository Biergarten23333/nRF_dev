...
TAG_DEVICE_NAME="${TAG_DEVICE_NAME:-Tag_rot_${TAG_ID}}"
TAG_SIGN_VERSION="${TAG_SIGN_VERSION:-0.0.1+${TAG_ID}}"
MASTER_CMAKE_ARGS_DEFAULT="-DAPP_MASTER_OTA_TARGET_TOKEN_ID=${TAG_ID} -DAPP_MASTER_OTA_TARGET_NAME=\\\"${TAG_DEVICE_NAME}\\\""
