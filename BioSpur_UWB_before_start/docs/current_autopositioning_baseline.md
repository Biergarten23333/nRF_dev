...
| `build-anchor-<X>-master` / `build-anchor-<X>-master-full` | matrix initiator | matrix stage | **A** | fresh Phase1 real build/flash/runtime verified on B (`anchor_role_phase1_20260329_224422`) |
| `build-anchor-<X>-matrix` | matrix responder | matrix stage | **A** | fresh Phase1 real build/flash/runtime verified on C with `allow_tag_polls=0` |
| `build-anchor-<X>-tag` | responder baseline | post-matrix / pre-Ref115 calibration | **A** | fresh Phase1 real build/flash/runtime verified on C with `allow_tag_polls=1` |
