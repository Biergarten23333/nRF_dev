...
TPL = os.path.join(HERE, "templates_v2")     # v2: corrected FP_INDEX alignment
AUTOPOS = os.path.join(HERE, "autopos")
STEP4 = os.path.join(HERE, "step4_v2")        # v2: corrected backprojection
OUT = os.path.join(HERE, "beamforming_v2")
