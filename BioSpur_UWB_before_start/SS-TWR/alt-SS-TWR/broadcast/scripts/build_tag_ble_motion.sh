...
tag_console_summary_enable="${APP_TAG_CONSOLE_SUMMARY_ENABLE:-0}"
tag_verbose_perf="${APP_TAG_VERBOSE_PERF:-0}"
tag_pending_print_period="${APP_TAG_PENDING_PRINT_PERIOD:-0}"
