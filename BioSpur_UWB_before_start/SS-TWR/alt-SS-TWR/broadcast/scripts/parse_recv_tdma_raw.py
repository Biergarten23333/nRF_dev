            ...
            tr_rows.append(
                {
                    ...
                    "imu_raw_valid": int(tr.get("imu_raw_valid") or 0),
                    "acc_x_mg": tr.get("acc_x_mg", ""),
                    "acc_y_mg": tr.get("acc_y_mg", ""),
                    "acc_z_mg": tr.get("acc_z_mg", ""),
                    "acc_norm_mg": tr.get("acc_norm_mg", ""),
                    "imu_timestamp_ms": tr.get("imu_timestamp_ms", ""),
                    "imu_poll_to_read_start_us": tr.get("imu_poll_to_read_start_us", ""),
                    "imu_poll_to_read_mid_us": tr.get("imu_poll_to_read_mid_us", ""),
                    "imu_poll_to_read_end_us": tr.get("imu_poll_to_read_end_us", ""),
                    "imu_read_duration_us": tr.get("imu_read_duration_us", ""),
                }
            )
