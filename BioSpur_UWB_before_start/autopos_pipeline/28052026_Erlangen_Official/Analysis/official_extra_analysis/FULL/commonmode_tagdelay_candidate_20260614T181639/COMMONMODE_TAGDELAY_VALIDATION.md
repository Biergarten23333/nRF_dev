...
- Trace check (2026-06-14): `91.153` mm is generated by the same `run_static_case(...)` loop as 0/80/95; the mild dip below the 80/95 neighbours is therefore a fresh candidate-pipeline feature, not a phase1d artifact.
