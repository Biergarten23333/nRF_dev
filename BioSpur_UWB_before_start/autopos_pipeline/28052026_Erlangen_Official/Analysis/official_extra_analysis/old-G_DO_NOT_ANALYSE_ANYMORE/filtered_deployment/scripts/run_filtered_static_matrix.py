...
def main() -> int:
    ...
    out_dir = Path(args.out_dir).resolve() if args.out_dir else official_root / "Analysis/official_extra_analysis/filtered_deployment"
    ...
    allowed_by_eval = {"all8": set(range(8)), "noG": {0, 1, 2, 3, 4, 5, 7}}
    ...
    for version in layout_versions:
        ...
        for eval_set in eval_sets:
            ...
            print(f"[filtered-static] block {block}/{total_blocks}: {version} {eval_set}", flush=True)
            for path in static_files:
