# Comprehensive Experimental Report V4: Erlangen 28-May-2026 V5 Analysis Campaign

Updated: 2026-06-20

This editorial revision keeps the V3 structure but updates the locked static headline
rows to the unified scalar convention. The change is not cosmetic: the V4/V5 p50
baseline gap shrinks, and the lower-tail intervention becomes the stronger part of
the story.
...
metric scale (Sim3 1.010 vs V4 0.958). Under scalar p50 evaluation, V4 barely
outperforms V5 (61.5 vs 63.5 mm median LOO). When tag-anchor NLOS bias is
reduced through lower-quantile range aggregation, V5 wins decisively (44.5 vs
53.9 mm), a ranking flip that is proportionally larger than the baseline gap.
This ranking flip is the strongest independent confirmation of the coupling
mechanism.
...
correct geometry. V4 is only marginally better under scalar p50 static positioning
on the Erlangen campaign, and its scale is wrong. V5 is physically better by
anchor-scale metrics and becomes empirically better when tag-anchor positive range
bias is reduced [source:
FULL_V5_scale_to_vicon/tables/v5_vs_v4_scale_comparison.csv;
FULL_V5_convention_unification/tables/unified_headline_table.csv;
...
defect directly. The scalar-convention headline table shows that V4's p50 layout
gives only a 2.0 mm median advantage in the same environment. The profile
likelihoods, Fisher eigenvalue, and morph valley show weakly identifiable
delay-layout directions. The raw-frame static batch result shows that once the
tag-anchor positive tail is reduced, V4's empirical advantage disappears [source:
...
Top-level findings after the V4 convention-unification revision:
...
- V4 remains the scalar p50 static LOO winner on this campaign, but only
  marginally: 61.5 mm for V4+LOO versus 63.5 mm for V5+LOO [source:
  FULL_V5_convention_unification/tables/unified_headline_table.csv].
- In static batch mode with about 1200 frames per link, lower-quantile tag-anchor
  ...
  FULL_V5_rawframe_bruteforce_v3/tables/s3_honest_ranking.csv].
- Under the unified scalar convention, the old V4 P95 advantage disappears:
  V4+LOO p50 has P95 157.0 mm, V5 p50 has P95 175.1 mm, and lower_trim_20
  improves the V5 tail slightly to 164.1 mm while reducing the median by about
  19 mm [source: FULL_V5_convention_unification/tables/unified_headline_table.csv;
  FULL_V5_rawframe_bruteforce_v3/tables/s3_honest_ranking.csv].
...
| Row | Variant | Convention | Median 3D mm | P95 mm | RMSE mm | Evaluation | Source |
| --- | --- | --- | --- | --- | --- | --- | --- |
| A | V4 production | scalar_p50_t4_fixed_d0 | 81.6 | 189.4 | 114.3 | in-sample, all 24 | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| B | V4 + D_LOO | scalar_p50_t4_dtag_loo_per_fold | 61.5 | 157.0 | 87.5 | LOO-CV | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| C | V5 baseline | scalar_p50_t4_dtag_loo_per_fold | 63.5 | 175.1 | 91.8 | LOO-CV | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| D | V5 apparent best | scalar_p30_inverse_rms_t4_dtag_loo_per_fold | 65.5 | 132.0 | 84.9 | in-sample post-selected | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| E | V4 apparent best | scalar_p30_inverse_rms_t4_dtag_loo_per_fold | 57.1 | 221.6 | 94.4 | in-sample post-selected | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| F | V5 corrected | scalar_optimism_corrected_median | 75.1 |  |  | OOB-bootstrap correction | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| G | V4 corrected | scalar_optimism_corrected_median | 66.7 |  |  | OOB-bootstrap correction | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| H | V5 bootstrap CI | scalar_bootstrap_ci_existing | [54.3, 63.7] |  |  | bootstrap 95% CI | FULL_V5_overnight_batch2/tables/n6_bootstrap_ci.csv |
| I | Nested CV (height) | scalar_nested_cv_existing | 82.9 |  |  | held-out test | FULL_V5_batch3_falsification/tables/f1_nested_cv_summary.csv |
| J | Nested CV (quadrant) | scalar_nested_cv_existing | 88.0 |  |  | held-out test | FULL_V5_batch3_falsification/tables/f1_nested_cv_summary.csv |
| K | Nested CV (spatial6) | scalar_nested_cv_existing | 94.2 |  |  | held-out test | FULL_V5_batch3_falsification/tables/f1_nested_cv_summary.csv |
| L | ROTO V5 per-frame | per_frame_dynamic | 101.5 | 214.4 | 126.2 | BEST-FIT-ALIGNED | FULL_V5_roto_deepdive/tables/r2_alignment_summary.csv |
| M | ROTO SE(3) aligned | per_frame_dynamic | 82.5 | 185.2 | 103.7 | diagnostic | FULL_V5_roto_deepdive/tables/r2_alignment_summary.csv |
| N | ROTO Sim3 aligned | per_frame_dynamic | 74.3 | 160.8 | 94.8 | diagnostic only | FULL_V5_roto_deepdive/tables/r2_alignment_summary.csv |
| O | lower_trim_20 + Huber30 + V5 | scalar_lower_trim_20_huber30_loo | 44.5 | 164.1 | 81.5 | LOO-CV | FULL_V5_rawframe_bruteforce_v3/tables/s3_honest_ranking.csv |
| P | lower_trim_20 + Huber30 + V5(e_i=0 anchor refit) | scalar_p50_anchor_ezero_huber30_loo | 43.2 | 163.1 | 81.8 | LOO-CV; anchor refit diagnostic | FULL_V5_anchor_lower_trim/tables/l3_master_comparison.csv |
| Q | Oracle lower bound | scalar_oracle_lower_bound | 44.6 |  |  | oracle | FULL_V5_rawframe_bruteforce_v3/tables/s6_master_ladder.csv |
| R | Bootstrap CI (lower_trim_20) | scalar_lower_trim_20_bootstrap_ci | [33.4, 82.8] |  |  | bootstrap 95% CI | FULL_V5_rawframe_bruteforce_v3/tables/s5_bootstrap_summary.csv |

Note: Row B (V4+LOO, 61.5 mm median) has P95 = 157.0 mm. Under
the scalar convention, V4's P95 is comparable to V5's (175.1 mm), and neither
is substantially better than the lower_trim_20 P95 (164.1 mm). The old apparent
V4 P95 advantage was a convention artifact from mean-position smoothing.
...
V5 common-mode anchor layout and V5 delay model. A later convention audit showed
that the earlier reports mixed a raw-frame mean-position V5 row with scalar
range-vector rows. The locked scalar p50 V5 baseline is now 63.5 mm median,
175.1 mm P95, and 91.8 mm RMSE under fold-wise D_tag LOO [source:
FULL_V5_convention_unification/tables/unified_headline_table.csv;
FULL_V5_final_audit/reports/P95_INCONSISTENCY_RESOLUTION.md].
...
sources, and 4 D_tag treatments. The diagonal production-like comparison was later
regenerated under the scalar convention: L_V4 with C_V4 and fold-wise D_tag LOO
gives 61.5 mm median 3D error, while L_V5 with C_V5 gives 63.5 mm [source:
FULL_V5_convention_unification/tables/unified_headline_table.csv]. The Vicon-anchor common-mode
...
reported without context. First, V5 has the better anchor geometry. Second, V4
marginally wins the p50 scalar LOO comparison (61.5 vs 63.5 mm), a gap of only
2.0 mm. This is where the cancellation hypothesis began: V4's scale compression
appears to cancel some structured positive range bias rather than merely
representing a worse geometry.
...
Under the locked scalar baseline, V4+C_V4 has a full LOO median of 61.5 mm and
V5+C_V5 has 63.5 mm. The older hard-CV degradation table still supplies the
split-sensitivity pattern: the worst height-tier degradation was 8.4 mm for V4
and 4.5 mm for V5 [source:
FULL_V5_convention_unification/tables/unified_headline_table.csv;
...
| --- | --- | --- | --- | --- |
| V4+C_V4 | 61.5 | LOW | 8.4 | 14.8 |
| V5+C_V5 | 63.5 | LOW | 4.5 | 16.9 |
| Vicon+C_Vicon_cm | 63.4 | LOW | 12.2 | 19.3 |

Residual-field analysis found structured residual bias in both V4 and V5. V4's mean
signed error magnitude is 33.2 mm, while V5's is 26.7 mm; the locked scalar 3D
median is still slightly lower for V4 at 61.5 mm than for V5 at 63.5 mm [source:
...
F1 showed that p30 plus inverse-RMS weighting plus recalibrated D_tag could improve
V5, but the stale follow-up tables are no longer the headline source. The
regenerated scalar V5 apparent-best row is 65.5 mm median, so it does not break a
45 mm target [source:
FULL_V5_convention_unification/tables/unified_headline_table.csv]. F2 showed that p30
...
the first headline comparison, but it has been superseded by the convention-unified
table: V4 production is now 81.6 mm, V5 baseline is 63.5 mm, V5 apparent best is
65.5 mm, and V4 apparent best is 57.1 mm [source:
FULL_V5_convention_unification/tables/unified_headline_table.csv;
FULL_V5_convention_unification/tables/headline_diff.csv].
...
The winner's-curse task estimated a mean optimism gap of 9.6 mm. After applying
that same gap to the regenerated scalar apparent-best rows, the corrected V4
improved median is 66.7 mm and the corrected V5 improved median is 75.1 mm
[source:
FULL_V5_convention_unification/tables/unified_headline_table.csv;
...
| Unexplained | 6.0 | gap=36.0 mm after scalar static convention update |
| TOTAL static-to-dynamic gap | 36.0 | dynamic=101.5, static=65.5 under the unified scalar static comparator |
...
e_i to zero improved the older V5 baseline by 3.3 mm in that counterfactual
...
| V4+LOO beats V5+LOO | V4-V5=-2.0 mm under scalar convention | >10 in the prior phase-center sweep | robust ranking, small margin |
...
enough to undo the V4-over-V5 static ranking or the V5 scale fix, although the
unified scalar ranking margin is now only 2.0 mm. The Vicon oracle rank, however,
is fragile, so Vicon-underperformance should not be treated as unique proof of
cancellation [source: FULL_V5_phase_center_sensitivity/tables/a6_robustness_summary.csv;
FULL_V5_convention_unification/tables/unified_headline_table.csv].
...
Under scalar p50 aggregation, V4+C_V4+D_LOO gives 61.5 mm median 3D error and
V5+C_V5+D_LOO gives 63.5 mm [source:
FULL_V5_convention_unification/tables/unified_headline_table.csv]. This is the
original paradox in its corrected form: V4 has the worse physical scale but a
slightly better single-environment p50 positioning median.
...
new evidence in this report because it links the empirical ranking directly to
the NLOS component that V4 was apparently cancelling. The baseline gap is only
2.0 mm, while the lower-tail intervention gives V5 a 9.4 mm advantage over the
best V4 geometry row, making the ranking flip a proportionally strong causal
signal.
...
The tail remains large but no longer worsens under the unified scalar convention.
V5 scalar p50 has median 63.5 mm and P95 175.1 mm. The lower-quantile V5 row
has median 44.5 mm, P95 164.1 mm, and RMSE 81.5 mm [source:
FULL_V5_convention_unification/tables/unified_headline_table.csv;
FULL_V5_rawframe_bruteforce_v3/tables/s3_honest_ranking.csv]. The method improves
both typical error and P95 relative to scalar V5 p50, but the remaining tail is
still too high for a deployment-style worst-case claim. The 5000-iteration
...
improved a prior non-headline V5 median by 3.3 mm [source:
...
histogram. The supported finding is that this improves median static positioning and
slightly improves P95 relative to scalar V5 p50 when enough frames are accumulated,
although the absolute P95 remains high [source:
FULL_V5_rawframe_bruteforce_v3/tables/s3_honest_ranking.csv].

Claim 29 remains Level A because it is the core mechanism result. Under scalar p50,
V4 marginally wins despite worse physical scale. Under lower-quantile tag-anchor
aggregation, V5 wins by a larger margin. That ranking flip independently confirms
that V4's p50 advantage came from beneficial delay-layout-NLOS cancellation on this
campaign [source:
FULL_V5_convention_unification/tables/unified_headline_table.csv;
FULL_V5_rawframe_bruteforce_v3/tables/s3_honest_ranking.csv].
...
scale. Second, V4 marginally wins p50 static positioning (61.5 vs 63.5 mm,
Delta=2.0 mm) because the distorted layout cancels part of the tag-anchor positive
bias. Third, reducing that positive bias reverses the empirical ranking and makes
V5 the better geometry (44.5 vs 53.9 mm). Fourth, the remaining P95 and ROTO
results show that typical static error and tail/dynamic error are different problems
[source:
FULL_V5_scale_to_vicon/tables/v5_vs_v4_scale_comparison.csv;
FULL_V5_convention_unification/tables/unified_headline_table.csv;
FULL_V5_rawframe_bruteforce_v3/tables/s3_honest_ranking.csv;
...
44.5 mm LOO versus 63.5 mm for the V5 scalar p50 baseline [source:
FULL_V5_rawframe_bruteforce_v3/tables/s3_honest_ranking.csv;
FULL_V5_convention_unification/tables/unified_headline_table.csv].

WARNING: lower_trim_20 improves both median and P95 under the unified scalar
convention, but the tail remains large in absolute terms. P95 is 175.1 mm for
V5 scalar p50 and 164.1 mm for V5 lower_trim_20. For applications where
worst-case error matters more than typical error, lower_trim_20 still needs
additional tail-reduction measures such as per-anchor stability checks or
anchor-specific fallback strategies [source:
FULL_V5_convention_unification/tables/unified_headline_table.csv;
FULL_V5_rawframe_bruteforce_v3/tables/s3_honest_ranking.csv].
...
Huber30, D_tag LOO`. Without those fields, 43.2 mm, 44.5 mm, 49.6 mm, and 63.5 mm
...
## Appendix A. Complete Numerical Registry V4
...
| STATIC ACCURACY | V4 production_median_3d | 81.6 | mm | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| STATIC ACCURACY | V4 production_p95_3d | 189.4 | mm | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| STATIC ACCURACY | V4 production_rmse_3d | 114.3 | mm | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| STATIC ACCURACY | V4_D_LOO_scalar_median_3d | 61.5 | mm | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| STATIC ACCURACY | V4_D_LOO_scalar_p95_3d | 157.0 | mm | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| STATIC ACCURACY | V4_D_LOO_scalar_rmse_3d | 87.5 | mm | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| STATIC ACCURACY | V5 baseline_median_3d | 63.5 | mm | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| STATIC ACCURACY | V5 baseline_p95_3d | 175.1 | mm | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| STATIC ACCURACY | V5 baseline_rmse_3d | 91.8 | mm | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| STATIC ACCURACY | V5 apparent_best_median_3d | 65.5 | mm | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| STATIC ACCURACY | V5 apparent_best_p95_3d | 132.0 | mm | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| STATIC ACCURACY | V5 apparent_best_rmse_3d | 84.9 | mm | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| STATIC ACCURACY | V4 apparent_best_median_3d | 57.1 | mm | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| STATIC ACCURACY | V4 apparent_best_p95_3d | 221.6 | mm | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| STATIC ACCURACY | V4 apparent_best_rmse_3d | 94.4 | mm | FULL_V5_convention_unification/tables/unified_headline_table.csv |
...
| STATIC ACCURACY | corrected_headline_v4_scalar | 66.7 | mm | FULL_V5_convention_unification/tables/unified_headline_table.csv |
| STATIC ACCURACY | corrected_headline_v5_scalar | 75.1 | mm | FULL_V5_convention_unification/tables/unified_headline_table.csv |
