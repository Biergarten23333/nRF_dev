...
Separately, the same campaign exhibits a \emph{tag-side} face of the coupling: once the balanced two-layer array brings the vertical into its well-conditioned regime, a common tag range bias aliases predominantly into height (VDOP/HDOP $\approx 1.6$), and an active vertical-injection control produced no dose-response. This is the residual-vertical limit reported by the companion system paper.
