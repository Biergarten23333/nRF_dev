...
\emph{headline} results are an anchor-side common-delay$\leftrightarrow$layout-scale degeneracy and a Vicon-grounded falsification protocol, while a
...
pure-UWB, self-calibrated vertical of ${\approx}62$~mm median absolute error (vs Vicon), near the ${\approx}63$~mm
inter-anchor Cram\'{e}r--Rao floor, from inter-anchor ranging alone --- a reference point that later
...
\emph{self-calibration} regime specifically: under reference-free inter-anchor self-calibration --- and under the eight-anchor broadcast SS-TWR acquisition the array is dimensioned for --- a
...
$\partial r/\partial z \to 0$ regime the Fisher analysis proves exactly singular for a coplanar
...
the centimetre level --- ${\approx}62$~mm median absolute against optical ground truth, near a ${\approx}63$~mm
