...
answer different questions. We separately examined whether the \emph{vertical}
...
vertical geometry, so no observability deficit is expected. Instead, because every
