...
The lower-tail Erlangen result should therefore not be framed as a new NLOS classifier. It is a probe. Under p50 ranges, the V4 layout wins despite its Sim3 scale of 0.958. When static tag-anchor positive tails are reduced by lower-quantile aggregation, V5 reaches 44.5 mm LOO while the best V4 raw-frame row is 53.9 mm. That ranking flip is the new evidence: reducing the bias that V4 was cancelling removes V4's empirical advantage.
...
Sim3 scale 1.010, yet V4 wins the p50 static LOO comparison at 57.9~mm
versus 67.8~mm for V5.
