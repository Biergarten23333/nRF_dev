...
Generated: 2026-06-05T14:20:09.306436+00:00
Elapsed: 3307.7 s
...
|---|---:|---:|---|
| G11_two_gpu_dynamic_balance | PASS | True | devices=['cuda:0', 'cuda:1']; partial_chunks_by_gpu={'cuda:0': 146, 'cuda:1': 142}; gpu0 max_util=100%, gpu1 max_util=94%; failed=0 |
| G12_cpu_parallel_execution | PASS | True | workers_per_device=4; total_workers=8; cpu_golden_mean=24.20s, simulate_imu_prior_mean=0.78s, torch_gpu_mean=2.55s |
