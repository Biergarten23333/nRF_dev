...
Generated: 2026-06-06T23:45:30.577780+00:00
Elapsed: 355.7 s
...
|---|---:|---:|---|
| G11_two_gpu_dynamic_balance | PASS | True | devices=['cuda:0']; partial_chunks_by_gpu={'cuda:0': 72}; gpu0 max_util=98%; failed=0 |
| G12_cpu_parallel_execution | PASS | True | workers_per_device=24; total_workers=24; build_track_tensors_mean=15.76s, cpu_golden_mean=0.29s, load_imu_prior_cache_mean=0.01s, load_track_tensors_cache_mean=0.00s, simulate_imu_prior_mean=0.76s, torch_gpu_mean=8.64s |
