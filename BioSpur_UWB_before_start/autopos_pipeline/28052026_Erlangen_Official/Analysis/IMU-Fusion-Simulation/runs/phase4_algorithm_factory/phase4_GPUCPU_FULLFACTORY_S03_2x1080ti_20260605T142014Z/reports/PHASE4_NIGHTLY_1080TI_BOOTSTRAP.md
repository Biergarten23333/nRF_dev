...
Generated: 2026-06-05T15:19:39.970276+00:00
Elapsed: 3564.1 s
...
|---|---:|---:|---|
| G11_two_gpu_dynamic_balance | PASS | True | devices=['cuda:0', 'cuda:1']; partial_chunks_by_gpu={'cuda:0': 144, 'cuda:1': 144}; gpu0 max_util=100%, gpu1 max_util=100%; failed=0 |
| G12_cpu_parallel_execution | PASS | True | workers_per_device=4; total_workers=8; cpu_golden_mean=26.29s, simulate_imu_prior_mean=0.81s, torch_gpu_mean=2.82s |
