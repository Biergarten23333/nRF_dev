...
Passive DWM1001-DEV listener for the 74HC595 LED bar.
...
```sh
west build -p always -b decawave_dwm1001_dev UWB_listener -d build-uwb-listener
```
...
```sh
./UWB_listener/scripts/build_and_flash.sh
```
