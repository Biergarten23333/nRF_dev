...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_DECAWAVE_DW1000_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_TRANSPORT_NETBUF_SIZE, 768);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RX_STACK_SIZE, 1800);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_NUS_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_LOG_LEVEL_WRN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_LOG_LEVEL, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HCI_DRIVER_LOG_LEVEL, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HCI_DRIVER_LOG_LEVEL_WRN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RPA_LOG_LEVEL_INHERIT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RPA_LOG_LEVEL, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ATT_LOG_LEVEL_INHERIT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ATT_LOG_LEVEL, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GATT_LOG_LEVEL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GATT_LOG_LEVEL_ERR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_LOG_LEVEL_INHERIT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CONN_LOG_LEVEL, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_KEYS_LOG_LEVEL_INHERIT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_KEYS_LOG_LEVEL, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_SERVICE_LOG_LEVEL_INHERIT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_SERVICE_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_CLOUD_FOTA_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_CLOUD_ALERT_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_CLOUD_LOG_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_CLOUD_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF52_ANOMALY_109_WORKAROUND_EGU_INSTANCE, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MGMT_FMFU_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUDIO_MODULE_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FATAL_ERROR_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_UTIL_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_DECAWAVE_DWM1001_DEV, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_DECAWAVE_DWM1001_DEV_NRF52832, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2C_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_USBD_COMMON_LOG_LEVEL, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USBC_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USBC_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IMG_MANAGER_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_SMP_VERBOSE_ERR_RESPONSE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_GRP_IMG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_GRP_IMG_UPDATABLE_IMAGE_NUMBER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_GRP_IMG_VERBOSE_ERR, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_GRP_IMG_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_GRP_OS_LOG_LEVEL, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_TRANSPORT_WORKQUEUE_STACK_SIZE, 3072);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_TRANSPORT_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STREAM_FLASH_LOG_LEVEL, 2);
