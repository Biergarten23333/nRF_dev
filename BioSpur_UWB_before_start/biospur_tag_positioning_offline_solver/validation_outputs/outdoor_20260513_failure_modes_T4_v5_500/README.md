...
| static | MC1_keep_6 | 74.1 | 3D repeatability median (mm) |
| roto | MC1_keep_6 | 42.0 | turn-center RMS median (mm) |
| static | MC1_keep_4 | 131.1 | 3D repeatability median (mm) |
| roto | MC1_keep_4 | 82.8 | turn-center RMS median (mm) |
| static | MC2_EBH_weak | 56.2 | 3D repeatability median (mm) |
| roto | MC2_EBH_weak | 26.8 | turn-center RMS median (mm) |
| static | MC3_burst_random_EBH_1p0s | 49.7 | 3D repeatability median (mm) |
| roto | MC3_burst_random_EBH_1p0s | 20.2 | turn-center RMS median (mm) |
| static | MC4_nlos_random_anchor_persistent_p200 | 53.7 | 3D repeatability median (mm) |
| roto | MC4_nlos_random_anchor_persistent_p200 | 23.2 | turn-center RMS median (mm) |
