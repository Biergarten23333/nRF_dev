...
| --- | --- | ---: | --- |
| static | MC1_keep_8 | 48.6 | 3D repeatability median (mm) |
| roto | MC1_keep_8 | 24.0 | turn-center RMS median (mm) |
...
| roto | MC2_EBH_weak | 28.1 | turn-center RMS median (mm) |
| static | MC3_burst_random_EBH_1p0s | 49.4 | 3D repeatability median (mm) |
| roto | MC3_burst_random_EBH_1p0s | 21.5 | turn-center RMS median (mm) |
| static | MC4_nlos_random_anchor_persistent_p200 | 52.2 | 3D repeatability median (mm) |
| roto | MC4_nlos_random_anchor_persistent_p200 | 26.3 | turn-center RMS median (mm) |
