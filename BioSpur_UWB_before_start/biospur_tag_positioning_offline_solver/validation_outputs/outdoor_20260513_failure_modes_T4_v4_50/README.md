...
| --- | --- | ---: | --- |
| static | MC1_keep_8 | 52.2 | 3D repeatability median (mm) |
| roto | MC1_keep_8 | 22.9 | turn-center RMS median (mm) |
...
| roto | MC3_burst_random_EBH_1p0s | 21.3 | turn-center RMS median (mm) |
| static | MC4_nlos_random_anchor_persistent_p200 | 52.0 | 3D repeatability median (mm) |
| roto | MC4_nlos_random_anchor_persistent_p200 | 26.4 | turn-center RMS median (mm) |
