...
| --- | --- | ---: | --- |
| static | MC1_keep_8 | 51.4 | 3D repeatability median (mm) |
| roto | MC1_keep_8 | 28.9 | turn-center RMS median (mm) |
| static | MC1_keep_6 | 75.5 | 3D repeatability median (mm) |
| roto | MC1_keep_6 | 47.7 | turn-center RMS median (mm) |
| static | MC1_keep_4 | 130.3 | 3D repeatability median (mm) |
| roto | MC1_keep_4 | 82.4 | turn-center RMS median (mm) |
| static | MC2_EBH_weak | 58.0 | 3D repeatability median (mm) |
| roto | MC2_EBH_weak | 33.4 | turn-center RMS median (mm) |
| static | MC3_burst_random_EBH_1p0s | 49.9 | 3D repeatability median (mm) |
| roto | MC3_burst_random_EBH_1p0s | 27.1 | turn-center RMS median (mm) |
| static | MC4_nlos_random_anchor_persistent_p200 | 54.4 | 3D repeatability median (mm) |
| roto | MC4_nlos_random_anchor_persistent_p200 | 34.7 | turn-center RMS median (mm) |
