...
| --- | --- | ---: | --- |
| static | MC1_keep_8 | 49.8 | 3D repeatability median (mm) |
| roto | MC1_keep_8 | 22.3 | turn-center RMS median (mm) |
...
| static | MC2_EBH_weak | 55.8 | 3D repeatability median (mm) |
| roto | MC2_EBH_weak | 27.0 | turn-center RMS median (mm) |
| static | MC3_burst_random_EBH_1p0s | 49.5 | 3D repeatability median (mm) |
| roto | MC3_burst_random_EBH_1p0s | 20.5 | turn-center RMS median (mm) |
| static | MC4_nlos_random_anchor_persistent_p200 | 52.3 | 3D repeatability median (mm) |
| roto | MC4_nlos_random_anchor_persistent_p200 | 23.7 | turn-center RMS median (mm) |
