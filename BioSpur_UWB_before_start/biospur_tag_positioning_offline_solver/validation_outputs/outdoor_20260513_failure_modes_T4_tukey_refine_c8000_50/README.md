...
| --- | --- | ---: | --- |
| static | MC1_keep_8 | 52.9 | 3D repeatability median (mm) |
| roto | MC1_keep_8 | 32.8 | turn-center RMS median (mm) |
...
| static | MC2_EBH_weak | 56.3 | 3D repeatability median (mm) |
| roto | MC2_EBH_weak | 29.9 | turn-center RMS median (mm) |
| static | MC3_burst_random_EBH_1p0s | 50.0 | 3D repeatability median (mm) |
| roto | MC3_burst_random_EBH_1p0s | 27.9 | turn-center RMS median (mm) |
| static | MC4_nlos_random_anchor_persistent_p200 | 54.7 | 3D repeatability median (mm) |
| roto | MC4_nlos_random_anchor_persistent_p200 | 35.6 | turn-center RMS median (mm) |
