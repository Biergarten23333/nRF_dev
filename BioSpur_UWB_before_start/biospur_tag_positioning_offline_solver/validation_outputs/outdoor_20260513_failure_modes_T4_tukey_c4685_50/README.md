...
| --- | --- | ---: | --- |
| static | MC1_keep_8 | 63.7 | 3D repeatability median (mm) |
| roto | MC1_keep_8 | 102.6 | turn-center RMS median (mm) |
...
| static | MC2_EBH_weak | 57.2 | 3D repeatability median (mm) |
| roto | MC2_EBH_weak | 43.0 | turn-center RMS median (mm) |
| static | MC3_burst_random_EBH_1p0s | 52.5 | 3D repeatability median (mm) |
| roto | MC3_burst_random_EBH_1p0s | 63.1 | turn-center RMS median (mm) |
| static | MC4_nlos_random_anchor_persistent_p200 | 63.1 | 3D repeatability median (mm) |
| roto | MC4_nlos_random_anchor_persistent_p200 | 100.1 | turn-center RMS median (mm) |
