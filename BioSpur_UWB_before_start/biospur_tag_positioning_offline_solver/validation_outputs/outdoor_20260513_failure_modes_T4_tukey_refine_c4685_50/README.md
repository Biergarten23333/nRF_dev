...
| --- | --- | ---: | --- |
| static | MC1_keep_8 | 59.2 | 3D repeatability median (mm) |
| roto | MC1_keep_8 | 32.9 | turn-center RMS median (mm) |
...
| static | MC2_EBH_weak | 56.8 | 3D repeatability median (mm) |
| roto | MC2_EBH_weak | 31.0 | turn-center RMS median (mm) |
| static | MC3_burst_random_EBH_1p0s | 52.4 | 3D repeatability median (mm) |
| roto | MC3_burst_random_EBH_1p0s | 28.7 | turn-center RMS median (mm) |
| static | MC4_nlos_random_anchor_persistent_p200 | 60.6 | 3D repeatability median (mm) |
| roto | MC4_nlos_random_anchor_persistent_p200 | 35.9 | turn-center RMS median (mm) |
