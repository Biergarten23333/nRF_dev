...
| static | MC1_keep_6 | 76.9 | 3D repeatability median (mm) |
| roto | MC1_keep_6 | 47.1 | turn-center RMS median (mm) |
| static | MC1_keep_4 | 130.3 | 3D repeatability median (mm) |
| roto | MC1_keep_4 | 82.4 | turn-center RMS median (mm) |
| static | MC2_EBH_weak | 57.9 | 3D repeatability median (mm) |
| roto | MC2_EBH_weak | 28.3 | turn-center RMS median (mm) |
| static | MC3_burst_random_EBH_1p0s | 50.6 | 3D repeatability median (mm) |
| roto | MC3_burst_random_EBH_1p0s | 20.6 | turn-center RMS median (mm) |
| static | MC4_nlos_random_anchor_persistent_p200 | 54.5 | 3D repeatability median (mm) |
| roto | MC4_nlos_random_anchor_persistent_p200 | 23.6 | turn-center RMS median (mm) |
