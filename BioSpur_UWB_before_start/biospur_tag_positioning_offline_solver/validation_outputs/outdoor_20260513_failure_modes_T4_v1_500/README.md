...
| --- | --- | ---: | --- |
| static | MC1_keep_8 | 49.7 | 3D repeatability median (mm) |
| roto | MC1_keep_8 | 23.2 | turn-center RMS median (mm) |
| static | MC1_keep_6 | 72.8 | 3D repeatability median (mm) |
| roto | MC1_keep_6 | 42.9 | turn-center RMS median (mm) |
| static | MC1_keep_4 | 130.3 | 3D repeatability median (mm) |
| roto | MC1_keep_4 | 83.6 | turn-center RMS median (mm) |
| static | MC2_EBH_weak | 56.2 | 3D repeatability median (mm) |
| roto | MC2_EBH_weak | 27.3 | turn-center RMS median (mm) |
| static | MC3_burst_random_EBH_1p0s | 49.5 | 3D repeatability median (mm) |
| roto | MC3_burst_random_EBH_1p0s | 21.2 | turn-center RMS median (mm) |
| static | MC4_nlos_random_anchor_persistent_p200 | 51.4 | 3D repeatability median (mm) |
| roto | MC4_nlos_random_anchor_persistent_p200 | 26.8 | turn-center RMS median (mm) |
