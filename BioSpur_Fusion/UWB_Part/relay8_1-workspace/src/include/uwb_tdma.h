...
#ifndef APP_TAG_RELAY6_DW_ANCHOR_ENABLE
#define APP_TAG_RELAY6_DW_ANCHOR_ENABLE 1U
#endif

#define TAG_BEACON_WINDOW_N_MIN 1U
#define TAG_BEACON_WINDOW_N_MAX 10U
#define TAG_BEACON_WINDOW_N_DEFAULT 1U
