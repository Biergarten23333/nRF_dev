...
tag_relay6_counter_enable="${APP_TAG_RELAY6_COUNTER_ENABLE:-1}"
tag_relay6_beacon_status_enable="${APP_TAG_RELAY6_BEACON_STATUS_ENABLE:-1}"
tag_relay6_dw_anchor_enable="${APP_TAG_RELAY6_DW_ANCHOR_ENABLE:-1}"
...

{
  ...
  printf 'set(APP_TAG_RELAY6_COUNTER_ENABLE %s CACHE STRING "Motion tag preload" FORCE)\n' "${tag_relay6_counter_enable}"
  printf 'set(APP_TAG_RELAY6_BEACON_STATUS_ENABLE %s CACHE STRING "Motion tag preload" FORCE)\n' "${tag_relay6_beacon_status_enable}"
  printf 'set(APP_TAG_RELAY6_DW_ANCHOR_ENABLE %s CACHE STRING "Motion tag preload" FORCE)\n' "${tag_relay6_dw_anchor_enable}"
...
(cd "$NCS_ROOT" && "$WEST_BIN" build \
  ...
  -DAPP_TAG_RELAY6_COUNTER_ENABLE="${tag_relay6_counter_enable}" \
  -DAPP_TAG_RELAY6_BEACON_STATUS_ENABLE="${tag_relay6_beacon_status_enable}" \
  -DAPP_TAG_RELAY6_DW_ANCHOR_ENABLE="${tag_relay6_dw_anchor_enable}" \
