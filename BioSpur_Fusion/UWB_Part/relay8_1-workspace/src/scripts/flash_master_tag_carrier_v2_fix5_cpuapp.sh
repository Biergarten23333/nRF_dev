...
# Phase-H fix5 CPUAPP-only update. CPUNET is byte-identical to fix1-fix4
...
readonly EXPECTED_APP_SHA="e8109f9f1a6820d30e4cc088ca376d257f7f271ccd3dfd71b953b569e92d349f"
...
build_dir="$repo_root/../builds/master-control-b120-m1-master-tag-lfrc-carrier-v2-fix5-relay2"
...
command_file="$(mktemp -t master_tag_fix5_XXXXXX.jlink)"
output_file="$(mktemp -t master_tag_fix5_XXXXXX.log)"
...
echo "[guard] marker=master-tag-carrier-v2-fix5"
...
echo "[ok] carrier-v2-fix5 CPUAPP programmed and verified"
