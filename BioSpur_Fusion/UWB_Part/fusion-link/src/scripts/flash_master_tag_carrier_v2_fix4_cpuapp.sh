...
# Phase-H fix4 CPUAPP-only update. CPUNET is byte-identical to fix1/fix2/fix3
# and is not opened here: J-Link 9.24a may mass-erase this board when a fresh
# CPUNET debug session attempts to unsecure the network core.

readonly EXPECTED_SNR="1050070698"
readonly EXPECTED_APP_SHA="7c8e18472ae32467a321b7e5e4204ffb8f82a7c737ba94cc4ddcaa2e09b33eea"
...
build_dir="$repo_root/../builds/master-control-b120-m1-master-tag-lfrc-carrier-v2-fix4-relay2"
...
command_file="$(mktemp -t master_tag_fix4_XXXXXX.jlink)"
output_file="$(mktemp -t master_tag_fix4_XXXXXX.log)"
...
echo "[guard] marker=master-tag-carrier-v2-fix4"
...
echo "[ok] carrier-v2-fix4 CPUAPP programmed and verified"
