...
# Phase-H fix2 CPUAPP-only update. CPUNET is byte-identical to fix1 and is not
# opened here: J-Link 9.24a may mass-erase this board when a fresh CPUNET debug
# session attempts to unsecure the network core.

readonly EXPECTED_SNR="1050070698"
readonly EXPECTED_APP_SHA="827b64f4bf7955740b5a49e74fcf4c2042baf1f6131d82aaad3d5e68e71c71d7"
...
build_dir="$repo_root/../builds/master-control-b120-m1-master-tag-lfrc-carrier-v2-fix2-relay2"
...
command_file="$(mktemp -t master_tag_fix2_XXXXXX.jlink)"
output_file="$(mktemp -t master_tag_fix2_XXXXXX.log)"
...
echo "[guard] marker=master-tag-carrier-v2-fix2"
...
echo "[ok] carrier-v2-fix2 CPUAPP programmed and verified"
