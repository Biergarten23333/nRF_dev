...
# Destructive, one-shot-per-authorized-batch relay8-payload Master_Tag carrier
# ceremony.
# Every J-Link process is locked to probe 1050070698 and an explicit core.

readonly EXPECTED_SNR="1050070698"
readonly CARRIER_MARKER="master-tag-carrier-v2-fix13-relay8"
...
readonly EXPECTED_APP_SHA="6986a927d1ebbf1a153daf4fe53e47aa9717066ffe27876e86f502a2d60aec4f"
readonly EXPECTED_PAYLOAD_SHA="751d38ffe3c18f5793a71275a0d84b86c8400e191f4ab09d455fddadf0db5731"
readonly EXPECTED_ZIP_SHA="7bf026807213aefbe1b142dcfaf052be46996e5d8225964c7b3d170a1aa0186f"
...
if [ "$#" -lt 1 ] || [ "$#" -gt 2 ]; then
	echo "Usage: $0 1050070698 [relay8_20260801]" >&2
	exit 2
fi
...
build_dir="$repo_root/../builds/master-control-b120-m1-master-tag-lfrc-carrier-v2-fix13-relay8"
...
log_root="$repo_root/../logs/relay8_20260801/carrier_fix13_relay8/ceremony"
...
echo "[ok] fix13-relay8 dual-core ceremony programmed and verified"
