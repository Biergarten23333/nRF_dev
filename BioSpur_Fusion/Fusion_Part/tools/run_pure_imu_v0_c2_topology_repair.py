#!/usr/bin/env python3
"""Fresh C2-only progressive repair: clean phases plus rest topology."""
...
RUN_REL = Path("logs/pure_imu_v0_c2_topology_repair_20260828T145040Z")
...
def initialize() -> Path:
    ...
    payload = {
        "schema": "biospur-pure-imu-v0-c2-topology-repair-preselection-v1",
        ...
        "repair_contract": {
            ...
            "lower_limb_branch": (
                "SIGNAL_VERIFIED_REST_LEFT_RIGHT_TOPOLOGY_NO_NODE_SWAP"
            ),
...
def main() -> None:
    ...
    parser.add_argument(
        "mode", choices=("initialize", "synthetic", "capture2"),
    )
