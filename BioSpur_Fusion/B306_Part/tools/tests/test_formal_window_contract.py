...
class FormalWindowTests(unittest.TestCase):
    def test_contract_accepts_mandated_guard_slot(self):
    ...
    def test_contract_rejects_count11_before_capture(self):
    ...
    def test_contract_rejects_occupied_guard_slot(self):
        with self.assertRaises(ValueError):
            assert_formal_window_contract(
