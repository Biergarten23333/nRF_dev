#!/usr/bin/env python3
"""Earn B306-v33 confirmation using the frozen two-command round trip."""
...
confirm_b306_v32.B306_MARKER = "b306-imu-relay-v33"
confirm_b306_v32.MASTER_MARKER = "dk-fusion-imu-relay-v29"
