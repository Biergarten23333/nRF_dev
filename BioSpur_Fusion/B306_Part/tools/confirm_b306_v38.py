#!/usr/bin/env python3
"""Earn B306-v38 confirmation using the frozen two-command round trip."""
import sys
import confirm_b306_v32
confirm_b306_v32.B306_MARKER = "b306-imu-relay-v38"
confirm_b306_v32.MASTER_MARKER = "dk-fusion-imu-relay-v32"
