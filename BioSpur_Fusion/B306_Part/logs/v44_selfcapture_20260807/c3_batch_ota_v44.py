...
EVID = ROOT / "UWB_Part/logs/v44_fleet_20260807/B_OTA"
OPS = ROOT / "UWB_Part/logs/deploy_20260806/b_fusion_ops.py"

SOURCE_MARKER_DEFAULT = "b306-imu-relay-v43"
# Observed end to end by the 4.2 PING gate at 20:34:47, not assumed.
SOURCE_MARKER = {}  # all ten measured on v43 by the 13:50 PING gate
TARGET_MARKER = "b306-imu-relay-v44"
BUILD_PREFIX = "dk-ota-b306-v44-"
CONFIRM_TOOL = "confirm_b306_v44.py"
MASTER_MARKER = "dk-fusion-imu-relay-v36"
RESTORE_BUILD = "dk-fusion-imu-relay-v36-a"
RESTORE_MERGED_SHA = "7a7d02cdae13b4450ffea0cb2a46607d481f3760a95e6c38d4c9dd03a2290b56"
RESTORE_BIN_SHA = "59bd57b80d762f5c3d9af9b0d0d303d288584f6f06f5baf5349a3cf3c5628b47"
...
UPDATER_SHA = {}
for _line in (ROOT / "B306_Part/logs/v44_selfcapture_20260807/A2_UPDATERS/BUILD_HASHES.txt").read_text().splitlines():
...
# BSF8BC4 excluded: already on v44, confirmed, and canary-validated after a
# hard power cycle. Re-running its transaction would only re-open a
# boot-confirm rollback window on a board that is already correct.
ORDER = ("BSF6C53", "BSF1120", "BSF31CC", "BSFEC35", "BSFB165",
         "BSF3C79", "BSFC2CC", "BSF44AD", "BSFAA61")
